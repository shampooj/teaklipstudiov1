              ...
              >
                ...
                {originalImage && (
                  <div className="mt-5 flex items-start gap-3">
                    ...
                    >
                      We need your help! Brown skin is insanely underrepresented in AI — but we're trying to change that. By checking this box, you consent to adding your image to Teak's Brown Skin Database for AI Research. As a thank you, you'll get a 10% off discount code. You can request deletion anytime at{" "}
