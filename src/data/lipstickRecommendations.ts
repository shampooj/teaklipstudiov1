...
export const PRODUCT_DETAILS: Record<string, { label: string; description: string; color: string }> = {
  "Amira": { label: "Demi-Satin Color Study Lipstick in Amira", description: "Soft mauve-brown nude with a natural demi-satin finish", color: "#b5837a" },
  "Amrit": { label: "Demi-Satin Color Study Lipstick in Amrit", description: "Deep rich terracotta-brick with chocolate undertones", color: "#8b4533" },
  "Jiya": { label: "Demi-Satin Color Study Lipstick in Jiya", description: "Timeless, bold red — think Old Hollywood glamour", color: "#b91c1c" },
  "Riya": { label: "Demi-Satin Color Study Lipstick in Riya", description: "Warm terracotta-brown matte with a 90s supermodel vibe", color: "#a0522d" },
  "Neha": { label: "Sheer Lipstick Balm in Neha", description: "Deep berry-plum with a luxurious, moody vibe", color: "#7c2d4b" },
  "Saanvi": { label: "Demi-Satin Color Study Lipstick in Saanvi", description: "Warm rosewood-brown with a velvety finish", color: "#9b5e5e" },
  "Kiran": { label: "Demi-Satin Color Study Lipstick in Kiran", description: "Classic true red with warm undertones", color: "#c41e3a" },
  "Anjali": { label: "Sheer Lipstick Balm in Anjali", description: "Sheer rosy-nude with a hydrating balm finish", color: "#c98b8b" },
  "Farrah": { label: "Demi-Satin Color Study Lipstick in Farrah", description: "Soft peachy-pink with a luminous sheen", color: "#d4917a" },
  "Ruchi": { label: "Demi-Satin Color Study Lipstick in Ruchi", description: "Light coral-pink with a dewy glow", color: "#e08b7a" },
  "Pooja": { label: "Soft Matte Lipstick in Pooja", description: "Rich brown-berry with a soft matte finish", color: "#6b3a4a" },
  "Aaliyah": { label: "Demi-Satin Color Study Lipstick in Aaliyah", description: "Deep plum-chocolate with warm undertones", color: "#5c2e3e" },
  "Priya": { label: "Soft Matte Lipstick in Priya", description: "Warm dusty rose with a natural finish", color: "#b07070" },
  "Sejal": { label: "Sheer Lipstick Balm in Sejal", description: "Nude-pink with a barely-there tint", color: "#c9907a" },
  "Shivani": { label: "Soft Matte Lipstick in Shivani", description: "Muted mauve with earthy undertones", color: "#8a6070" },
  "Nyla": { label: "Soft Matte Lipstick in Nyla", description: "Warm cinnamon-brown with a smooth soft matte finish", color: "#8b5a3a" },
  "Karina": { label: "Soft Matte Lipstick in Karina", description: "Cool-toned berry with a sophisticated edge", color: "#7a3050" },
  "Sonia": { label: "Soft Matte Lipstick in Sonia", description: "Dark pomegranate red with a juicy berry bite", color: "#8f2839" },
};
