...
const LOOK_SHADES: Record<string, string> = {
  ...
  "berry-wine": "extremely sheer, barely-there ROSY PINK berry-red lip tint — almost transparent, like a single swipe of tinted lip oil. The natural lip color and texture must remain clearly visible underneath. The tint should read as a warm ROSY PINK with a hint of berry-red, NOT brown or muddy. On brown or darker lips, push the color toward a clear warm rose-pink rather than letting it blend into brown. Think 'just bitten lips' with a rosy glow. Glossy, dewy, ultra-sheer — absolutely no opacity or full coverage",
